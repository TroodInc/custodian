...
func (record *Record) GetValue(getterConfig interface{}, transaction transactions.DbTransaction, getRecordCallback func(objectClass, key string, ip []string, ep []string, depth int, omitOuters bool) (*Record, error)) interface{} {
...
func getSimpleValue(targetRecord *Record, keyParts []string, transaction transactions.DbTransaction, getRecordCallback func(objectClass, key string, ip []string, ep []string, depth int, omitOuters bool) (*Record, error)) interface{} {
	if len(keyParts) == 1 {
...
//get key value traversing down if needed
func getGenericValue(targetRecord *Record, getterConfig map[string]interface{}, transaction transactions.DbTransaction, getRecordCallback func(objectClass, key string, ip []string, ep []string, depth int, omitOuters bool) (*Record, error)) interface{} {
