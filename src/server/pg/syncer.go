...
func (syncer *Syncer) CreateObj(transaction transactions.DbTransaction, metaDescription *object.Meta, descriptionSyncer object.MetaDescriptionSyncer) error {
...
func (syncer *Syncer) UpdateObj(transaction transactions.DbTransaction, currentMetaDescription *object.Meta, newMetaDescription *object.Meta, descriptionSyncer object.MetaDescriptionSyncer) error {
	tx := transaction.(*PgTransaction)
...
func (syncer *Syncer) diffScripts(transaction transactions.DbTransaction, metaDescription *object.Meta, descriptionSyncer object.MetaDescriptionSyncer) (DdlStatementSet, error) {
	tx := transaction.(*PgTransaction)
	metaDdlFactory := NewMetaDdlFactory(descriptionSyncer)
...
func (syncer *Syncer) UpdateObjTo(transaction transactions.DbTransaction, metaDescription *object.Meta, descriptionSyncer object.MetaDescriptionSyncer) error {
	tx := transaction.(*PgTransaction)
...
func (syncer *Syncer) ValidateObj(transaction transactions.DbTransaction, metaDescription *object.Meta, descriptionSyncer object.MetaDescriptionSyncer) (bool, error) {
