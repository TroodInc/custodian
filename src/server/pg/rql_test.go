...
var _ = Describe("RQL test", func(){
	...
	metaStore := object.NewStore(transactions.NewFileMetaDescriptionSyncer("./"), syncer,transactions.NewGlobalTransactionManager(nil, nil) )
	...
	dataNode := &data.Node{
		KeyField:   meta.FindField(meta.Key),
		Meta:       meta,
