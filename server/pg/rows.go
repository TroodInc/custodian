...
// TODO should manage with pgx.Rows
type Rows struct {
	*sql.Rows
}
...
func (rows *Rows) Parse(fields []*meta.FieldDescription) ([]map[string]interface{}, error) {
	// TODO pgx doesnot contain Columns() method insetead one can use
	// https://pkg.go.dev/github.com/jackc/pgx/v4#Rows FieldDescriptions()
	// https://github.com/jackc/pgx/issues/114
